LOVELY_INTEGRITY = 'f82b3682001d90f0d6fd65002225d6a6b4ccac16505fdcd0c4f2b572caa6cca2'
...
function generate_card_ui(_c, full_UI_table, specific_vars, card_type, badges, hide_desc, main_start, main_end, card)
    ...
    elseif _c.set == 'Enhanced' then 
        ...
        elseif _c.effect == 'Glass Card' then loc_vars = {cfg.Xmult, SMODS.get_probability_vars(card, 1, cfg.extra)}
    ...
    elseif _c.set == 'Tarot' then
       ...
       elseif _c.name == "The Wheel of Fortune" then loc_vars = {SMODS.get_probability_vars(card, 1, cfg.extra)};  info_queue[#info_queue+1] = G.P_CENTERS.e_foil; info_queue[#info_queue+1] = G.P_CENTERS.e_holo; info_queue[#info_queue+1] = G.P_CENTERS.e_polychrome; 
