LOVELY_INTEGRITY = 'ba7cd3c088dad06a8e639fc277952cad1fc2915194a5dae92562ce57f7d8c4b6'
...
function Card:generate_UIBox_ability_table(vars_only)
    ...
    elseif self.ability.set == 'Joker' then -- all remaining jokers
        ...
        elseif self.ability.name == 'Space Joker' then loc_vars = {SMODS.get_probability_vars(self, 1, self.ability.extra)}
        ...
        elseif self.ability.name == '8 Ball' then loc_vars = {SMODS.get_probability_vars(self, 1, self.ability.extra)}
        ...
        elseif self.ability.name == 'Gros Michel' then loc_vars = {self.ability.extra.mult, SMODS.get_probability_vars(self, 1, self.ability.extra.odds)}
        ...
        elseif self.ability.name == 'Business Card' then loc_vars = {SMODS.get_probability_vars(self, 1, self.ability.extra)}
        ...
        elseif self.ability.name == 'Bloodstone' then local a, b = SMODS.get_probability_vars(self, 1, self.ability.extra.odds); loc_vars = {a, b, self.ability.extra.Xmult}
        ...
        elseif self.ability.name == 'Cavendish' then loc_vars = {self.ability.extra.Xmult, SMODS.get_probability_vars(self, 1, self.ability.extra.odds)}
        ...
        elseif self.ability.name == 'Reserved Parking' then loc_vars = {self.ability.extra.dollars, SMODS.get_probability_vars(self, 1, self.ability.extra.odds)}
        ...
        elseif self.ability.name == 'Hallucination' then loc_vars = {SMODS.get_probability_vars(self, 1, self.ability.extra)}
