LOVELY_INTEGRITY = '96d6beff67149e7c313eb9cc18eeb0f5fe984e28e8602a5f0616ce94370348a1'
...
function Blind:stay_flipped(area, card, from_area)
    if not self.disabled then
        ...
        if area == G.hand then
            if self.name == 'The Wheel' and SMODS.pseudorandom_probability(self, pseudoseed('wheel'), 1, 7) then
                return true
